...
//
//                org.apache.flink.yarn.Utils.deleteApplicationFiles(applicationDir.toUri().toString());
//            }
//
...
//                org.apache.flink.yarn.Utils.getQualifiedRemoteProvidedLibDirs(configuration, yarnConfiguration);
//
//        final Optional<Path> providedUsrLibDir =
//                org.apache.flink.yarn.Utils.getQualifiedRemoteProvidedUsrLib(configuration, yarnConfiguration);
//
...
//                if (!org.apache.flink.yarn.Utils.isRemotePath(entry.getValue().filePath)) {
...
//            File f = new File(System.getenv("YARN_CONF_DIR"), org.apache.flink.yarn.Utils.YARN_SITE_FILE_NAME);
//            LOG.info(
...
//                                    org.apache.flink.yarn.Utils.YARN_SITE_FILE_NAME,
//                                    yarnSitePath,
//                                    "",
//                                    LocalResourceType.FILE,
//                                    false,
...
//                    fileUploader
//                            .registerSingleLocalResource(
//                                    org.apache.flink.yarn.Utils.KRB5_FILE_NAME,
//                                    krb5ConfPath,
//                                    "",
//                                    LocalResourceType.FILE,
//                                    false,
